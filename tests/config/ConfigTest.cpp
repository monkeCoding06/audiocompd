...
void registerConfigTests(TestRunner& runner) {
    runner.add("Config.ValidatesAndLoadsAlsaConfiguration", [] {
        ...
        require(alsa.sampleRate == 48'000, "sample rate was parsed incorrectly");
        require(alsa.channels == 2, "channel count was parsed incorrectly");
